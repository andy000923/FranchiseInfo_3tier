...
async function fetchData() {
  ...
  try {
    const response = await axios.get('https://franchise.ftc.go.kr/mnu/00013/program/userRqst/list.do?searchCondition=&searchKeyword=&column=&selUpjong=&selIndus=&pageUnit=20000&pageIndex=1', {
      headers: header
    });
